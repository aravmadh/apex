...
![](images/task-01-step-01-create-page.png)
...
1. In Page Designer, select the **Leave Calendar** page. In the page **CSS** property, add this inline CSS:
    ...
    ```
    ![](images/task-02-step-01-add-css-01.png)
    ![](images/task-02-step-01-add-css-02.png)

2. Select the Calendar region. In its attributes, set **CSS Class Column** to **CSS_CLASS**.
    ![](images/task-02-step-02-select-css-class.png)
...
![](images/task-02-step-03-create-event.png)
